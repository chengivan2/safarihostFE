import Logo8 from '@/assets/img/logo/header-logo8.png'
...
const Footer9 = () => {
  return (
    <>
      <footer className="vl-footer-area8 bg-cover">
        <div>
          <Container>
            <Row>
              ...
              <Col lg={3} md={6} sm={6}>
                <div className="vl-footer-widget8 mb-50 ml-70 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={2} md={4} sm={6}>
                <div className="vl-footer-widget8 mb-50 ml-0 md:ml-0 sm:ml-0">
                  <h4>Useful Links</h4>
                  <div className="vl-footer-list">
                    <UseFulLink />
                  </div>
              ...
              <Col lg={4} md={8} sm={6}>
                <div className="vl-footer-subscribe8 vl-footer-widget mb-50 ml-30 sm:ml-0 md:ml-0">
                  <h4>Newsletter</h4>
                  ...
                  <form action="#" className="_relative">
                    ...
                    <div className="button">
                      <button className="theme-btn20" type="submit">
                        Subscribe{' '}
