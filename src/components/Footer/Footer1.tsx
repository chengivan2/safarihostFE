'use client'
import Noise1 from '@/assets/img/bg/noise-bg1.jpg'
import FooterLogo from '@/assets/img/logo/footer-logo1.png'
...
const Footer1 = () => {
  return (
    <>
      <footer className="vl-footer-area1 bg-cover" style={{ backgroundImage: `url(${Noise1.src})` }}>
        <div>
          <Container>
            <Row>
              <Col xl={3} lg={3} md={6} sm={6}>
                <div className="vl-footer-widget mb-50">
                  ...
                  <div className="vl-footer-social text-start mt-20">
                    <BrandIcon />
                  </div>
                </div>
              </Col>
              <Col lg={3} md={6} sm={6}>
                <div className="vl-footer-widget mb-50 ml-70 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={2} md={4} sm={6}>
                <div className="vl-footer-widget mb-50 ml-0 md:ml-0 sm:ml-0">
                  <h4>Useful Links</h4>
                  <div className="vl-footer-list">
                    <UseFulLink />
                  </div>
              ...
              <Col lg={4} md={8} sm={6}>
                <div className="vl-footer-subscribe vl-footer-widget mb-50 ml-30 sm:ml-0 md:ml-0">
                  <h4>Newsletter</h4>
        ...
        <CopyRight />
        <Image src={Service1} alt="" className="sec-shape1" />
        <Image src={Service2} alt="" className="sec-shape2" />
      </footer>
    </>
  )
}
