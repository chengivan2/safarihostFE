...
const Footer10 = () => {
  return (
    <>
      <footer className="vl-footer-area10 bg-cover">
        <div>
          <Container>
            <Row>
              <Col xl={3} lg={3} md={6} sm={6}>
                <div className="vl-footer-widget mb-50">
                  ...
                  <div className="vl-footer-social10 text-start mt-20">
                    <BrandIcon />
                  </div>
                </div>
              </Col>
              <Col lg={3} md={6} sm={6}>
                <div className="vl-footer-widget10 mb-50 ml-70 md:ml-30 sm:ml-0">
                  <h4>Quick Links</h4>
              ...
              <Col lg={2} md={4} sm={6}>
                <div className="vl-footer-widget10 mb-50 ml-0 md:ml-0 sm:ml-0">
                  <h4>Useful Links</h4>
                  <div className="vl-footer-list">
                    <UseFulLink />
                  </div>
              ...
              <Col lg={4} md={8} sm={6}>
                <div className="vl-footer-subscribe10 vl-footer-widget mb-50 ml-30 sm:ml-0 md:ml-0">
                  <h4>Newsletter</h4>
                  ...
                  <form action="#" className="_relative">
                    ...
                    <div className="button">
                      <button className="theme-btn28" type="submit">
                        Subscribe{' '}
