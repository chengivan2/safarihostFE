...
const TopNavBar5 = () => {
  ...
  return (
    <>
      <header>
        <div id="vl-header-sticky" className={`vl-header-area5 header-tranperent header-${scrollY > 100 && 'sticky'}`}>
            ...
            <Row className="align-items-center">
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <Link href="/home/hosting-01">Web Hositng 01</Link>
                                  <div className="btn-area1">
                                    <Link href="/" className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <Link href="/home/hosting-02">Cloud Hosting 02</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-02"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <Link href="/home/hosting-03">VPS Hosting 03</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-03"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <Link href="/home/hosting-04">Web Hositng 04</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-04"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <Link href="/home/hosting-05">Web Hositng 05</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-05"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <Link href="/home/hosting-06">Web Hositng 06</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-06"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <Link href="/home/hosting-07">WordPress Hosting 07</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-07"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <Link href="/home/hosting-08">Shared Hosting 08</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-08"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <Link href="/home/hosting-09">Shared Hosting 09</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-09"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <Link href="/home/hosting-10">Shared Hosting 10</Link>
                                  <div className="btn-area1">
                                    <Link
                                      href="/home/hosting-10"
                                      className="btn_theme5 btn_theme_active5 mt_40 wow fadeInDown"
                                      data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
              ...
              <Col lg={3} md={6} xs={6}>
                <div className="vl-header-btn text-end d-none d-lg-block">
                  <Link href=".contact" className="btn_theme10 btn_theme_active10 mt_40 wow fadeInDown" data-wow-duration="0.8s">
                    Get Started Now
                    <span />
                  </Link>
                </div>
                <div className="vl-header-action-item d-block d-lg-none">
                  <button onClick={toggle} type="button" className="vl-offcanvas-toggle">
