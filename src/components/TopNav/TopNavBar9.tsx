...
import HeaderLogo from '@/assets/img/logo/header-logo8.png'
            ...
            <Row className=" align-items-center">
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-02" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-03" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-04" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-05" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                </div>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-06" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-07" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-08" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-09" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                  <div className="space20 d-lg-none d-block" />
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-10" className="theme-btn20" data-wow-duration="0.8s">
                                      View Page <span />
                                    </Link>
                                  </div>
                                </div>
              ...
              <Col lg={3} md={6} xs={6}>
                <div className="vl-header-btn text-end d-none d-lg-block">
                  <Link className="theme-btn20" href="/contact">
                    Get Started Now{' '}
