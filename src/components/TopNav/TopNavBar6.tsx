...
import logo9 from '@/assets/img/logo/header-logo9.png'
...
const TopNavBar6 = () => {
  ...
  return (
    <>
      <header>
        <div id="vl-header-sticky" className={`vl-header-area9 header-tranperent header-${scrollY > 100 && 'sticky'}`}>
            ...
            <Row className="align-items-center">
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link className="theme-btn24" href="/home/hosting-02">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-03" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-04" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-05" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                            ...
                            <Row className="gx-3 row-cols-1 row-cols-md-1 row-cols-lg-5">
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-06" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-07" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-08" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-09" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
                              ...
                              <Col>
                                <div className="vl-home-thumb mt-20">
                                  ...
                                  <div className="btn-area1">
                                    <Link href="/home/hosting-10" className="theme-btn24" data-wow-duration="0.8s">
                                      View Page{' '}
                                      <span className="arrow1">
                                        <FaArrowRight className="fa-solid" />
                                      </span>
              ...
              <Col lg={3} md={6} xs={6}>
                <div className="vl-header-btn text-end d-none d-lg-block">
                  <Link className="theme-btn24" href="/domain">
                    Get Started Now{' '}
                    <span className="arrow1">
                      <FaArrowRight className="fa-solid" />
                    </span>
                ...
                <div className="vl-header-action-item d-block d-lg-none">
                  <button type="button" onClick={toggle} className="vl-offcanvas-toggle border-dark">
                    <FaBarsStaggered className="fa-duotone fa-solid text-dark" />
                  </button>
                </div>
              </Col>
            </Row>
