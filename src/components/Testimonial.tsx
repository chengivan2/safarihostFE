...
const Testimonial = () => {
    ...
    return (
        <>
            <div className="tes1 sp bg-cover" style={{backgroundImage: `url(${Noise.src})`}}>
                <Container>
                    <Row>
                ...
                <span className="sub-title" data-aos="zoom-in-left" data-aos-duration={800}>
                  testimonials
                                ...
                                <h2 className="text-anime-style-3">Success Stories from Our Users</h2>
                            </div>
                        </Col>
                    </Row>
                            ...
                            <div className="slider-area _relative">
                                ...
                                <div className="tes1-arrows">
                                    <div className="prev-arrow">
                                        <button onClick={() => sliderRef1.current?.slickPrev()}>
                                            <FaAngleUp className="fa-solid"/>
                                        </button>
                                    </div>
                                    <div className="next-arrow">
                                        <button onClick={() => sliderRef1.current?.slickNext()}>
                                ...
                                <Slider ref={sliderRef2} asNavFor={nav1} {...settings2}>
                                    {testimonials.map((item, idx) => (
                                        <div key={idx} className="testimonial-vertical">
                                            ...
                                            <p>
                                                “At Hostic our clients&#39; success is our top priority. As one client of on
                                                shared, Working with Finazze transformed our
                                                business. Their expertise in financial strategy us identify growth
                                                opportunity and we never considered. With their guidance,
                                                we increased our.”
                                            </p>
