'use client'
import { links, links2 } from '@/assets/data/other'
...
import date1 from '@/assets/img/icons/details-date.svg'
import Image from 'next/image'
import Link from 'next/link'
import { Col, Container, Row } from 'react-bootstrap'
import { FaCheck, FaFacebookF, FaInstagram, FaLinkedinIn, FaReply } from 'react-icons/fa'
        ...
        <Container>
          <Row>
            <Col lg={8} className="m-auto">
              <div className="blog-post-detials">
                <article>
                  <div className="details-single-posts">
                    ...
                    <div className="content-details-area">
                      <ul>
                        ...
                        <li className="date">
                          <Link href="#">
                            <Image src={date1} alt="" /> 10 October 2025
                          </Link>
                        </li>
                        <li className="date">
                          <Link href="#">
