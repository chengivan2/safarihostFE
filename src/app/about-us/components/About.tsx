'use client'
import Page from '@/assets/img/images/about-page-sec1.png'
import Shape from '@/assets/img/shapes/about2-shape.png'
...
const About = () => {
  ...
  return (
    <>
      <div className="about2 _relative sp">
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="about2-images">
                <div className="shape-bg1">
                  <Image src={Shape} alt="" height={732} />
                </div>
